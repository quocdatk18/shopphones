...
export const createOrder = expressAsyncHandler(async (req, res) => {
  ...
  if (req.body.orderItems.length === 0) {
    ...
    const order = new OrderModel({
      ...
      cancelOrder: false,
      salePercent: Number(req.body.salePercent) || 0,
      totalSalePrice: Number(req.body.totalPrice) - (Number(req.body.totalPrice) * (Number(req.body.salePercent) || 0) / 100),
      orderItems: req.body.orderItems,
      shippingAddress: {
        city: req.body.shippingAddress.city,
        district: req.body.shippingAddress.district,
        village: req.body.shippingAddress.village,
